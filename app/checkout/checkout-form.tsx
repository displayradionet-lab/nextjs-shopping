        ...
        <div className="md:col-span-3">
          ...
          <div>
            {isDeliveryDateSelected && deliveryDateIndex != undefined ? (
              <div className="grid  grid-cols-1 md:grid-cols-12  my-5 pb-3">
                <div className="flex text-lg font-bold  col-span-5">
                ...
                <Card className="md:ml-8">
                  <CardContent className="p-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className=''>
                        <div className=" font-bold mt-2 lg:ml-20">
                          ...
                          <ul className='my-4'>
                            ...
                            >
                              {AVAILABLE_DELIVERY_DATES.map((dd) => (
                                <div key={dd.name} className="flex relative">
                                  <RadioGroupItem
                                    value={dd.name}
                                    id={`address-${dd.name}`}
                                  />
                                  <Label
                                    className="pl-2 -mt-2 space-y-8 cursor-pointer"
                                    htmlFor={`address-${dd.name}`}
                                  >
                                    <div className="text-green-700 font-semibold my-2">
                                      {
                                        formatDateTime(
                                          calculateFutureDate(dd.daysToDelivery)
                                        ).dateOnly
                                      }
                                    </div>
