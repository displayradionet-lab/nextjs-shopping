...
export default function OrderPaymentForm({
  ...
  const handleCreatePayPalOrder = async () => {
    try {
      console.log('Creating PayPal order for order ID:', order._id.toString());
  ...
  const handleApprovePayPalOrder = async (data: { orderID: string }) => {
    try {
      ...
      toast.error('Error approving PayPal payment');
      ...
      <CardContent className="p-4">
        <div>
          ...
          <div className="space-y-2">
            ...
            {!isPaid && paymentMethod?.toLowerCase() === 'paypal' && (
              <div>
      ...
      <div className="grid md:grid-cols-4 gap-6">
        <div className="md:col-span-3">
          ...
          <div>
            ...
            <div>
              <p>
                Delivery Date: {formatDateTime(expectedDeliveryDate || new Date()).dateOnly}
              </p>
              <ul>
                {items.map((item) => (
                  <li key={item.slug}>
